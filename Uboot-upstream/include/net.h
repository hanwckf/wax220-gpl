...
enum proto_t {
	...
	TFTPSRV, TFTPPUT, LINKLOCAL, FASTBOOT, WOL, UDP, NMRP
};
...
void NmrpSetTimeout(ulong, thand_f *);/* Set timeout handler */
void NmrpLedSetTimeout(ulong, thand_f *);/* Set timeout handler */
