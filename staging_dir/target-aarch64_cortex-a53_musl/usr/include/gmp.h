...
#define __GMP_CFLAGS "-Os -pipe -mcpu=cortex-a53 -fno-caller-saves -fno-plt -fhonour-copts -Wno-error=unused-but-set-variable -Wno-error=unused-result -DCUSTOMER_MODEL_WAX220 -fmacro-prefix-map=/home2/caojingzhe/mtk7986_openwrt2/opt2102/build_dir/target-aarch64_cortex-a53_musl/gmp-6.2.1=gmp-6.2.1 -Wformat -Werror=format-security -fstack-protector-strong -D_FORTIFY_SOURCE=1 -Wl,-z,now -Wl,-z,relro -DPIC -fPIC "
